...
# ensure kdewin can log in
Write-Host "Setting kdewin user file permissions"
New-Item -ItemType Directory -Force -Path "C:\Users\kdewin\.ssh"
C:\Windows\System32\icacls.exe "C:\Users\kdewin" /grant "kdewin:(OI)(CI)F"
C:\Windows\System32\icacls.exe "C:\Program Files\OpenSSH\bin" /grant "kdewin:(OI)RX"
C:\Windows\System32\icacls.exe "C:\Program Files\OpenSSH\usr\sbin" /grant "kdewin:(OI)RX"
...
C:\Windows\System32\icacls.exe "C:\Windows\Temp" /grant "kdewin:(OI)(CI)F"
...
Set-Content C:\Users\kdewin\.ssh\environment $sshenv
